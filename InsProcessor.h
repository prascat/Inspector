...
public:
    ...
    InspectionResult performInspection(const cv::Mat& image, const QList<PatternInfo>& patterns, int stripCrimpMode = 0, const QString& cameraName = "");
    ...
    bool checkAnomaly(const cv::Mat& image, const PatternInfo& pattern, double& score, InspectionResult& result);
